      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7">
        ...
        <Card className="col-span-3">
          <CardHeader>
            ...
            <CardDescription>
              Commencez rapidement vos tâches.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="space-y-2">
              <div className="flex items-center p-2 rounded-md hover:bg-muted cursor-pointer">
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">Créer un nouveau projet</p>
                </div>
              </div>
              ...
              <div className="flex items-center p-2 rounded-md hover:bg-muted cursor-pointer">
                ...
                <div>
                  <p className="text-sm font-medium">Inviter équipe</p>
                  <p className="text-xs text-muted-foreground">Inviter des collaborateurs</p>
                </div>
              </div>
            </div>
          </CardContent>
